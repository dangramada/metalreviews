...
- **Metal Storm ingest memory fix: three verifications pending, 2026-09-16.**
  ...
  challenge pages after ~130 local test loads. A re-run 3 hours later was still blocked after the first page (see decision doc). Re-run `npx tsx scratch/check_metalstorm_blocking_parity.mts` (paced, HTTP-status-recording)
