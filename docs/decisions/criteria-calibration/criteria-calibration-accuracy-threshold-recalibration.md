...
post-Harris trajectory CSVs (`docs/backups/criteria-calibration/escalation-signal-oracle-trajectories-postharris-2026-08-16.csv`,
875 rows; `docs/backups/criteria-calibration/escalation-signal-real-session-trajectories-2026-08-16.csv`, 141 rows), whose
...
**Derived data:** `docs/backups/criteria-calibration/accuracy-threshold-recalibration-2026-08-17.csv` (945 rows),
`docs/backups/criteria-calibration/accuracy-threshold-recalibration-fits-2026-08-17.json`,
`docs/backups/criteria-calibration/accuracy-threshold-final-region-determinacy-2026-08-17.json`.
