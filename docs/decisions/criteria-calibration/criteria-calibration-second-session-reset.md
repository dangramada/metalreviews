...
| `docs/backups/criteria-calibration/second-session-accuracy-trajectory-2026-08-15.csv` final row | `n=71`, `accuracy 0.999977`, `veryHigh`, `fired true`, `last_change_answer_index 45` |
