...
is a `select`). Derived data: `docs/backups/criteria-calibration/degree-tier-recon-2026-08-18.csv`, 945 rows.
...
`docs/backups/criteria-calibration/accuracy-threshold-recalibration-2026-08-17.csv` (945 rows, same 12 traces):
