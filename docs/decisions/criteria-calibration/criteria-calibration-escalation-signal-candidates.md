...
`docs/backups/criteria-calibration/synthetic-oracle-trajectories-2026-08-16.csv` predates that fix by ~7 hours and was not reused.
...
- `docs/backups/criteria-calibration/escalation-signal-real-session-trajectories-2026-08-16.csv` — 141 rows, both real sessions.
- `docs/backups/criteria-calibration/escalation-signal-oracle-trajectories-postharris-2026-08-16.csv` — 875 rows, all 10 oracles.
