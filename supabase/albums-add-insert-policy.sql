...
-- insert path (see docs/decisions/album-identity/album-identity-frontend-favorites.md). `albums.sql`
...
--
-- Per docs/decisions/album-identity/album-identity-decisions.md §5 (Layer 1 prevention): authenticated
