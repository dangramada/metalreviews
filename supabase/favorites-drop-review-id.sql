-- Final step of docs/decisions/album-identity-migration.md's favorites remap.
-- Prerequisite: favorites.album_id already populated and verified (confirmed: 5/5 rows,
-- 0 collisions found — see checkpoint 2 in album-identity-migration.md). Deferred at that
