...
// docs/decisions/criteria-calibration/criteria-calibration-medium-gate-redesign.md. The old pair-coverage
...
// from degree-3+ answers (docs/decisions/criteria-calibration/criteria-calibration-engine.md's "Part 4
